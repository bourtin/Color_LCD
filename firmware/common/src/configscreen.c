...
static Field motorMenus[] = {
            ...
            FIELD_EDITABLE_UINT(_S("Current ramp up", "Cur ram up"), &ui_vars.ui8_ramp_up_amps_per_second_x10, "amps", 4, 100, .div_digits = 1),
            FIELD_EDITABLE_UINT(_S("Current ramp down", "Cur ram do"), &ui_vars.ui8_ramp_down_amps_per_second_x10, "amps", 4, 100, .div_digits = 1),
