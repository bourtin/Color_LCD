...
static Field batterySOCMenus[] =
		{
            FIELD_EDITABLE_ENUM("Batt symbol", &ui_vars.ui8_battery_soc_symbol, "SOC %", "voltage"),
...
static Field technicalMenus[] = {
  ...
  FIELD_READONLY_UINT("Weight with offset", &ui_vars.ui8_pedal_weight_with_offset, ""),
  FIELD_READONLY_UINT("Weight without offset", &ui_vars.ui8_pedal_weight, ""),
